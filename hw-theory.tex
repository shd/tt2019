...
\item $\Pi_n, n > 0$ --- все выражения, логически эквивалентные выражениям вида $\exists x.S$, где $S \in \Sigma_{n-1}$;
\item $\Sigma_n, n > 0$ --- все выражения, логически эквивалентные выражениям вида $\forall x.P$, где $P \in \Pi_{n-1}$.
\end{itemize}

Заметим, что, например, $\Pi_2$ состоит из выражений вида $\forall x.\exists y.\forall z.R$.
