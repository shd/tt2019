...
\begin{enumerate}
\item Вариант 1.
Докажите, что $\forall x\in\mathbb{N_0}.(x+2)^2 = x^2 + 4x + 4$
\item Вариант 2.
Докажите, что $\forall x\in\mathbb{N_0}.(2x+1)^2 = 4x^2 + 4x + 1$
\item Вариант 3.
Докажите, что $\forall x\in\mathbb{N_0}.x^2 + 1 = 1 \rightarrow x = 0$
\item Вариант 4.
Докажите, что $\forall x\in\mathbb{N_0}.x < 3 \rightarrow x = 0 \vee x = 1 \vee x = 2$
\item Вариант 5.
...
\item Вариант 8.
Докажите, что $\forall x\in\mathbb{N_0}.x = 0 \vee x = 1 \vee x = 2 \rightarrow x < 3$
\end{enumerate}
